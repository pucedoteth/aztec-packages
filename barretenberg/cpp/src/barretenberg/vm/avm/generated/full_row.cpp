...
template <typename FF> std::vector<std::string> AvmFullRow<FF>::names()
{
    return { "byte_lookup_sel_bin",
             ...
             "mem_w_in_tag",
             "merkle_tree_clk",
             "merkle_tree_diff_inv",
             "merkle_tree_expected_tree_root",
             "merkle_tree_is_member",
             "merkle_tree_latch",
             "merkle_tree_leaf_index",
             "merkle_tree_leaf_index_is_even",
             "merkle_tree_leaf_value",
             "merkle_tree_left_hash",
             "merkle_tree_output_hash",
             "merkle_tree_path_len",
             "merkle_tree_path_len_inv",
             "merkle_tree_right_hash",
             "merkle_tree_sel_merkle_tree",
             "merkle_tree_sibling_value",
             "poseidon2_B_10_0",
             "poseidon2_B_10_1",
             "poseidon2_B_10_2",
             "poseidon2_B_10_3",
             ...
             "poseidon2_full_input_0",
             "poseidon2_full_input_1",
             "poseidon2_full_input_2",
             "poseidon2_full_input_len",
             "poseidon2_full_num_perm_rounds_rem",
             "poseidon2_full_num_perm_rounds_rem_inv",
             "poseidon2_full_output",
             "poseidon2_full_padding",
             "poseidon2_full_sel_merkle_tree",
             "poseidon2_full_sel_poseidon",
             "poseidon2_full_start_poseidon",
             ...
             "poseidon2_sel_poseidon_perm_immediate",
             "poseidon2_sel_poseidon_perm_mem_op",
             "poseidon2_space_id",
             ...
             "perm_pos2_fixed_pos2_perm_inv",
             "perm_slice_mem_inv",
             "perm_merkle_poseidon2_inv",
             "perm_main_alu_inv",
             "perm_main_bin_inv",
             "perm_main_conv_inv",
             "perm_main_sha256_inv",
